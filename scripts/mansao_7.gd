...
@export var cat_reset_pos: Vector2 = Vector2(875, 175) 
@export var rat1_reset_pos: Vector2 = Vector2(875, 175) 
...
const TEMPO_DE_PAUSA_DO_CICLO = 1.3     
...
func start_tremor_pattern():
	if main_camera:
		...
		printerr("Erro: Nó 'Camera' não encontrado para iniciar o padrão de tremor. Verifique o caminho em @onready var main_camera no script da cena.")
